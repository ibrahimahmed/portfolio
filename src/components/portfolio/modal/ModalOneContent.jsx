        ...
        <figcaption>
          ...
          <div className="row open-sans-font">
            ...
            <div className="col-12 col-sm-6 mb-2">
              ...
              <span className="ft-wt-600 uppercase">Amr Eid</span>
            </div>
            {/* End .col */}
            ...
            <div className="col-12 col-sm-6 mb-2">
              ...
              <span className="ft-wt-600 uppercase">Angular , Typescript , Node.js , Mysql , AWS</span>
            </div>
            {/* End .col */}
            ...
            <div className="col-12 col-sm-6 mb-2">
              ...
              <span className="ft-wt-600 uppercase">
                <a
                  href="https://owingsgenie.com.au/#/login"
                  target="_blank"
                  rel="noreferrer"
                >
                  https://owingsgenie.com.au/
                </a>
              </span>
            </div>
            {/* End .col */}
